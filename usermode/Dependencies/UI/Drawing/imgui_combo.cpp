...
void InitializeFonts() {
    ...
    fonts::inter_font = io.Fonts->AddFontFromFileTTF("path/to/inter_regular.ttf", 16.0f);
    fonts::inter_bold_font = io.Fonts->AddFontFromFileTTF("path/to/inter_bold.ttf", 16.0f);
    fonts::inter_bold_font2 = io.Fonts->AddFontFromFileTTF("path/to/inter_bold2.ttf", 16.0f);
    fonts::inter_bold_font3 = io.Fonts->AddFontFromFileTTF("path/to/inter_bold3.ttf", 16.0f);
    fonts::inter_bold_font4 = io.Fonts->AddFontFromFileTTF("path/to/inter_bold4.ttf", 16.0f);
    fonts::inter_font_b = io.Fonts->AddFontFromFileTTF("path/to/inter_b.ttf", 16.0f);
    fonts::combo_icon_font = io.Fonts->AddFontFromFileTTF("path/to/combo_icon.ttf", 16.0f);
}
