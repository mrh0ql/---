...
bool ImGui::Tab(const char* label, ImTextureID icon, const ImVec2& size_arg, bool active)
{
    ...
    window->DrawList->AddImage(icon, rect.Min + ImVec2(14, 10), rect.Min + ImVec2(30, 26), ImVec2(0, 0), ImVec2(1, 1), GetColorU32(colors::accent_color, it_anim->second.alpha));
...
bool ImGui::Keybind(ImTextureID icon, const char* label, int* key, int* mode, bool label_active)
{
    ...
    PushStyleColor(ImGuiCol_WindowBg, ImVec4(ImColor(19, 19, 19, 100)));
